...
<div class="row">
  <div class="col-md-8 mx-auto">
      <div class="card">
          ...
          <div class="card-body">
              <p class="card-text">Update subject information</p>
              <form action="<?php echo URL_ROOT; ?>/admins/editSubject/<?php echo $data['id']; ?>" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <select name="stream_id" id="stream_id" class="form-select <?php echo (!empty($data['stream_id_err'])) ? 'is-invalid' : ''; ?>">
                          ...
                          <?php foreach($data['streams'] as $stream) : ?>
                              <option value="<?php echo $stream->id; ?>" <?php echo ($data['stream_id'] == $stream->id) ? 'selected' : ''; ?>>
