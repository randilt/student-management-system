  ...
  <div class="col-md-8 mx-auto">
      <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h2 class="card-title">Edit Stream</h2>
              <a href="<?php echo URL_ROOT; ?>/admins/manageStreams" class="btn btn-light">Back to Manage Streams</a>
          </div>
          <div class="card-body">
              <p class="card-text">Update stream information</p>
              <form action="<?php echo URL_ROOT; ?>/admins/editStream/<?php echo $data['id']; ?>" method="post">
                  ...
                  <div class="form-group mt-4">
                      <button type="submit" class="btn btn-primary btn-block">Update Stream</button>
                  </div>
              </form>
          </div>
      </div>
